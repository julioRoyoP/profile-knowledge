 ...
 * about. Consumers use pattern matching in a {@code switch} (see
 * {@link ChargePaymentStep}) and the compiler rejects the code if a new variant
 * is added but left unhandled.
 */
